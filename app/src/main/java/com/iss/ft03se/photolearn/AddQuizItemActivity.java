...
public class AddQuizItemActivity extends AppCompatActivity implements LoadImage.ImageCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_quizitem);
        l = this;
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ques == null || ques.isEmpty() || opt1 == null || opt1.isEmpty() || opt2 == null || opt2.isEmpty() || opt3 == null || opt3.isEmpty() || opt4 == null || opt4.isEmpty() || answerExp == null || answerExp.isEmpty() || ans == 0) {
                        Toast.makeText(AddQuizItemActivity.this, Constants.PROVIDED_ALL_PARAMETERS, Toast.LENGTH_SHORT).show();
                    } else if (url == null || url.isEmpty()) {
                        Toast.makeText(AddQuizItemActivity.this, Constants.UPLOAD_IMAGE, Toast.LENGTH_SHORT).show();
                    } else {
            ...
            case Constants.GALLERY:
                if (imageReturnedIntent != null) {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(AddQuizItemActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        if (isImageSelected) {
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(AddQuizItemActivity.this, Constants.UPLOAD_SUCCESSFUL, Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();

                    Log.i("ImageView", "image:" + imageView);
                    Picasso.with(AddQuizItemActivity.this).load(downloadUrl).into(imageView);
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception exception) {

                    Toast.makeText(AddQuizItemActivity.this, Constants.ERROR_IN_UPLOADING, Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            });

        } else {
            Toast.makeText(AddQuizItemActivity.this, Constants.SELECT_IMAGE, Toast.LENGTH_SHORT).show();
        }
    }
