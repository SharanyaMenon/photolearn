...
public class AddQuizTitleActivity extends AppCompatActivity {
    Button button;
    EditText et;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_quiztitle);
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (title == null || title.isEmpty()) {
                        Toast.makeText(AddQuizTitleActivity.this, Constants.ADD_TITLE, Toast.LENGTH_SHORT).show();
                    } else {
