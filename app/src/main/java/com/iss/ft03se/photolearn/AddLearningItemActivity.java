...
import com.iss.ft03se.photolearn.Utilities.ImageCallback;
import com.iss.ft03se.photolearn.Utilities.ImageUploadUtility;
import com.iss.ft03se.photolearn.Utilities.GeoLocation;
...
public class AddLearningItemActivity extends AppCompatActivity implements LoadImage.ImageCallBack{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_learningitem);
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (photoDesc == null || photoDesc.isEmpty()) {
                        Toast.makeText(AddLearningItemActivity.this, Constants.INVALID_INPUT, Toast.LENGTH_SHORT).show();
                    } else if (url == null || url.isEmpty()) {
                        Toast.makeText(AddLearningItemActivity.this, Constants.UPLOAD_IMAGE, Toast.LENGTH_SHORT).show();
                    } else {
                        try {
            ...
            case Constants.GALLERY:
                if (imageReturnedIntent != null) {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(AddLearningItemActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        if (isImageSelected) {
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Toast.makeText(AddLearningItemActivity.this, Constants.UPLOAD_SUCCESSFUL, Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();

                    Log.i("ImageView", "image:" + imageView);
                    Picasso.with(AddLearningItemActivity.this).load(downloadUrl).into(imageView);
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception exception) {

                    Toast.makeText(AddLearningItemActivity.this, Constants.ERROR_IN_UPLOADING, Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();
                }
            });

        } else {
            Toast.makeText(AddLearningItemActivity.this, Constants.SELECT_IMAGE, Toast.LENGTH_SHORT).show();
        }
    }
