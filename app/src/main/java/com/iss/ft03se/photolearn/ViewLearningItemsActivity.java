...
import com.iss.ft03se.photolearn.PageView.PagerViewLearningtem;
...
public class ViewLearningItemsActivity extends AppCompatActivity {
    private Button mButton;
    private ViewPager mViewPager;
    Toolbar toolbar;


    List<PagerViewLearningtem> mPageViews = new ArrayList<>();
    ...
    private void initView() {
        setContentView(R.layout.view_learningitems);
    ...
    private class MyAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            PagerViewLearningtem basePageView = mPageViews.get(position);
    ...
    private void initEvent() {
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ViewLearningItemsActivity.this, AddLearningItemActivity.class);
    ...
    public void addPage(LearningItem item) {
        ...
        PagerViewLearningtem basePageView = new PagerViewLearningtem(this, item.getItemID(), item.getPhotoDesc(), item.getGps(), item.getPhotoURL());
