...
//        }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ans == 0) {
                    Toast.makeText(LoginActivity.this, "Select the login identity first.", Toast.LENGTH_SHORT).show();
                } else {
                    signIn();
                }
                    ...
                    public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                        if (firebaseAuth.getCurrentUser() != null) {
                            if (trainer.isChecked()) {
                                ...
                                startActivity(new Intent(LoginActivity.this, ViewSessionsActivity.class));
                                finish();
                                ...
                                startActivity(new Intent(LoginActivity.this, EnterLearningsessionActivity.class));
                                finish();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (result.isSuccess()) {
                ...
                Toast.makeText(LoginActivity.this, "Auth went wrong", Toast.LENGTH_SHORT);
                //sign in failed
            }
        }
    }
