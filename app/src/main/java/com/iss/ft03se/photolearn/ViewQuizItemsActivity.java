...
public class ViewQuizItemsActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_quizitems);
        ...
        adapter = new RecyclerAdapter(this, dataSet, map, QuizItem.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(ViewQuizItemsActivity.this, AddQuizItemActivity.class));
            }
        });
    }
