...
import com.iss.ft03se.photolearn.fragment.LearningTitleFragment;
import com.iss.ft03se.photolearn.fragment.QuizTitleFragment;
...
public class TrainerTitlesActivity extends AppCompatActivity implements RecyclerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.trainer_titles);
    ...
    private void initData() {
        ...
        fragments.add(new LearningTitleFragment());
        fragments.add(new QuizTitleFragment());
    }
