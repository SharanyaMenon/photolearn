...
public class ChooseLearningsessionModeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.choose_learningsession_mode);
            ...
            public void onClick(View v) {
                if (State.getCurrentSession() != null) {
                    ...
                    if (((RadioButton) findViewById(R.id.edit_button)).isChecked()) {
                        ...
                        startActivity(new Intent(ChooseLearningsessionModeActivity.this, ParticipantTiltlesActivity.class));
