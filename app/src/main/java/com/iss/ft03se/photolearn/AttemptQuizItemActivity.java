...
import com.iss.ft03se.photolearn.PageView.PagerViewQuizItem;
...
public class AttemptQuizItemActivity extends AppCompatActivity {
    ...
    List<PagerViewQuizItem> mPageViews = new ArrayList<>();

    List<QuizItem> quizItemList = new ArrayList<>();
    HashMap<String, Integer> answers = new HashMap();

    private AttemptQuizItemActivity.MyAdapter mAdapter;
    ...
    private void initView() {
        setContentView(R.layout.attempt_quiz_item);
        ...
        mAdapter = new AttemptQuizItemActivity.MyAdapter();
    ...
    private class MyAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            PagerViewQuizItem basePageView = mPageViews.get(position);
     ...
     */ private void showPopwindow() {
        ...
        // Show At the bottom
        window.showAtLocation(AttemptQuizItemActivity.this.findViewById(R.id.Terminate),
                Gravity.BOTTOM, 0, 0);
        ...
        mTerminate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mTerminate.getText() == Constants.SUBMIT) {
                    ...
                    Intent intent = new Intent(getBaseContext(), CompleteQuizActivity.class);
    ...
    public void addPage(QuizItem item) {
        ...
        PagerViewQuizItem basePageView = new PagerViewQuizItem(this,item,choiceselected);
